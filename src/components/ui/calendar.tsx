    ...
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(
          ...
          "h-8 w-8 p-0 font-xl font-normal aria-selected:opacity-100"
        ),
        day_range_start: "day-range-start",
        day_range_end: "day-range-end",
        day_selected:
          "bg-green-400 text-white hover:text-stone-950 hover:bg-green-100 hover:bg-green-100 focus:bg-primary focus:text-white",
