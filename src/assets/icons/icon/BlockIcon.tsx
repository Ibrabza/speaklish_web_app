...
const BlockIcon: FC = () => <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
    <path d="M12 16.5V14.5" stroke="#F93C65" strokeWidth="1.5" strokeLinecap="round"/>
    <path
        ...
        stroke="#F93C65" strokeWidth="1.5"/>
    <path d="M7.5 9V6.5C7.5 4.01472 9.51472 2 12 2C14.4853 2 16.5 4.01472 16.5 6.5V9" stroke="#F93C65"
